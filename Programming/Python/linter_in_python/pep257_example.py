...
# @Date:   08-Nov-2016 20:11
# @Last modified by:   poudel
# @Last modified time: 10-Nov-2016 11:11


# Install linter-pep8  and change settings
# ignore multiple white spaces around oprators  E221
# then we can align = symbol for the multiple varialbles in many lines.
